package com.stream.ai_agent.service;

import com.stream.ai_agent.dto.ChatRequest;
import com.stream.ai_agent.dto.ChatResponse;
import com.stream.ai_agent.tool.CalculatorTool;
import com.stream.ai_agent.tool.CurrencyTool;
import com.stream.ai_agent.tool.PresentInfoTool;
import com.stream.ai_agent.tool.WeatherTool;
...
public class AiService {
    ...
    public ChatResponse aiChat(ChatRequest request) {
        ...
        Flux<String> output = chatClient.prompt()
                ...
                .doOnComplete(() -> {
                    context.add(new AssistantMessage(builder.toString()));
                });
